...
//   Float_t         PFMETNoHFPhi;
   ...
   Float_t         KFactor_QCD_ggZZ_Nominal_weight;
   ...
   Float_t         KFactor_QCD_qqZZ_M_weight;
...
//   TBranch        *b_PFMETNoHFPhi;   //!
   ...
   TBranch        *b_KFactor_QCD_ggZZ_Nominal_weight;   //!
   ...
   TBranch        *b_KFactor_QCD_qqZZ_M_weight;   //!
...
void Tree::Init(TTree *tree, TString input_file_name, bool notZLregion)
{
   ...
   if ( !(input_file_name.Contains("Data")) )
   {
      ...
      {
         fChain->SetBranchAddress("KFactor_QCD_ggZZ_Nominal_weight", &KFactor_QCD_ggZZ_Nominal_weight, &b_KFactor_QCD_ggZZ_Nominal_weight);
      ...
      if ( input_file_name.Contains("ZZTo4l") )
      {
         ...
         //fChain->SetBranchAddress("KFactor_QCD_qqZZ_M_weight", &KFactor_QCD_qqZZ_M_weight, &b_KFactor_QCD_qqZZ_M_weight);
      ...
      //prefiringWeight", &L1prefiringWeight, &b_L1prefiringWeight);
