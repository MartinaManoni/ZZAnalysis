...
def printLumiPrelLeft(canvas, lumitext="13.6 TeV"):
...
def printLumiPrelOut(canvas, lumitext="13.6 TeV"):
    #change the CMS_lumi variables (see CMS_lumi.py)
    CMS_lumi.writeExtraText = 1
    CMS_lumi.extraText = "Preliminary"
    CMS_lumi.lumi_sqrtS = lumitext # used with iPeriod = 0, e.g. for simulation-only plots (default is an empty string)
...
def printLumiLeft(canvas, lumitext="13.6 TeV"):
    #change the CMS_lumi variables (see CMS_lumi.py)
...
def printLumiOut(canvas, lumitext="13.6 TeV"):
    #change the CMS_lumi variables (see CMS_lumi.py)
    CMS_lumi.writeExtraText = 0
    CMS_lumi.extraText = ""
    CMS_lumi.lumi_sqrtS = lumitext # used with iPeriod = 0, e.g. for simulation-only plots (default is an empty string)
