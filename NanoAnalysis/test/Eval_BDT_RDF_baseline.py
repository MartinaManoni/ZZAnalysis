...
ROOT_FILE = "/eos/user/m/mmanoni/test_BDT/PROD_samplesNano_2023preBPix_MC_fd6e1fef/ggH125/ZZ4lAnalysis.root"
TREE_NAME = "Events"
...
plt.title("Electron BDT Efficiency vs Reco $p_T$ (Era 2023preBPix)")
plt.grid(True)
plt.ylim(0, 1.05)
plt.legend()
plt.tight_layout()
